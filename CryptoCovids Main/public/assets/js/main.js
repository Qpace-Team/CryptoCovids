...
(function() {
  ...
  function ChangeBG(){
    const img = [
      ...
      'url("assets/img/bg-5.png")',
      'url("assets/img/bg-6.png")',
      'url("assets/img/bg-7.png")',
      'url("assets/img/bg-8.png")',
      'url("assets/img/bg-9.png")',
      'url("assets/img/bg-10.png")',
      'url("assets/img/bg-11.png")',
      'url("assets/img/bg-12.png")',
      'url("assets/img/bg-13.png")',
      'url("assets/img/bg-14.png")',
      'url("assets/img/bg-15.png")',
      'url("assets/img/bg-16.png")',
      'url("assets/img/bg-17.png")',
      'url("assets/img/bg-18.png")',
      'url("assets/img/bg-19.png")',    
    ]
